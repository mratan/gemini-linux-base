 ...
 * v4.10 removed GENL_ID_GENERATE and per-op .policy; v4.10+ registers ops
 * through the family struct via genl_register_family() (API-CHURN-LOG.md S1;
 * frank-w forum catalog: genetlink registration rework). Family definition
 * moved below the ops array it now references.
 */
...
static struct genl_family stp_dbg_gnl_family = {
	...
	.resv_start_op = __STP_DBG_COMMAND_MAX,
	.module = THIS_MODULE,
};
