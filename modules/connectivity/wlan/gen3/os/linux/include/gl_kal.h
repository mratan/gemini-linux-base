...
/* linux/ftrace_event.h was renamed to linux/trace_events.h in v4.14
 * (API-CHURN-LOG.md G1). Only the MET packet-trace path uses it, which is
 * compiled out here (CFG_MET_PACKET_TRACE_SUPPORT=0). */
